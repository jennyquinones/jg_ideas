class Carrito {
  ...
  insertarCarrito(producto) {
    ...
    row.innerHTML = `
            ...
            <td nowrap>${producto.titulo}</td>
            <td nowrap>S/. ${producto.precio}</td>
            <td>
  ...
  leerLocalStorageCompra() {
    ...
    productosLS.forEach(function (producto) {
      ...
      row.innerHTML = `
                <td>
                    <img src="${producto.imagen}" width=100 class="img-fluid">
                </td>
                <td nowrap>${producto.titulo}</td>
                <td nowrap>S/. ${producto.precio}</td>
                <td >
                ...
                <td id='subtotales' nowrap>${producto.precio * producto.cantidad}</td>
                <td>
                    <a href="#" class="borrar-producto fas fa-times-circle del_in_shop" data-id="${
                      producto.id
                    }"></a>
                </td>
            `;
